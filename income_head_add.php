          ...
          <form action="" method="POST">
              <div class="col-lg-12 d-flex">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="incom_name" required placeholder=" Name"> 
                    </div>
                        ...
                        $count = 1;
                            ...
                            while($result = mysqli_fetch_array($run)){ ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php if($role_name=='0'){ ?> <a onclick="return confirm('You are Sure..?')" class="btn btn-outline-danger"  style="font-size:15px; padding:5px; text-align:center; "href="income_head_add.php?in_herid=<?php echo $result['in_h_id']?>"><i class="far fa-trash-alt"></i> Delete </a> <?php }else{ echo "Delete"; } ?></td>
                                </tr>
                           <?php  }  ?>
