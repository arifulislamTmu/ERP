...
$msg ='<div class="alert bg-success">
      ...
      if(isset($_POST['save'])){
        ...
        echo  $msg2;
           ...
           VALUES('$cmr_p_id','$transiton_Id','$ctn_no','$total_taka','$ctn_qty','$delvry_we','$taka_par_kg','$cash_recevd','$payment_Id','$paymnt_meth','$current_due','$note','$today','$goods_name','$delvry_ctn','$total_g_w','$shipping_mark','$remaks','By Ship')";
           $run = mysqli_query($con,$insert);
    ...
    <form action="" method="POST">
     ...
     <tr>
         ...
         <?php
                $count = 1;
                $select = "SELECT * FROM `tbl_customer`
                INNER JOIN tbl_payment ON tbl_customer.cmr_p_id = tbl_payment.cmr_p_id WHERE shipment_type='By Ship' ORDER BY `tbl_payment`.`id` DESC
 ";
                $run = mysqli_query($con,$select);
                while($result= mysqli_fetch_array($run)){ ?>
                  <tr>
