            ...
            <div class="row">
               <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="empole_name" id="exampleInputEmail1" placeholder=" Name"> 
                    </div>
               </div>
               <div class="col-lg-4">
                <div class="form-group">
               ...
               <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="employe_mobile" id="exampleInputEmail1" placeholder="Phone" >
                </div>
           </div>
           <div class="col-lg-4">
                <div class="form-group">
                    <label for="exampleInputEmail1">Joining Date</label>
                    <input type="date" class="form-control"  name="joining_date" id="exampleInputEmail1">
                </div>
           </div>
           <div class="col-lg-4">
                <div class="form-group">
                    <label for="exampleInputEmail1">Employe Id No</label>
                    <input type="text" class="form-control"  name="eply_id_no"  placeholder="Id Number" >
                </div>
           </div>
           <div class="col-lg-4">
                <div class="form-group">
