...
$msg ='<div class="alert bg-success">
      ...
      if(isset($_POST['save'])){
        ...
        echo  $msg2;
           ...
           $insert = "INSERT INTO tbl_payment(cmr_p_id,transtion_id,ctn_no,total_taka,ctn_qty,delvry_we,taka_par_kg,cash_recevd,payment_id,paymnt_meth,current_due,note,date,goods_name,delvry_ctn,total_g_w,shipping_mark,remaks,shipment_type)
           VALUES('$cmr_p_id','$transiton_Id','$ctn_no','$total_taka','$ctn_qty','$delvry_we','$taka_par_kg','$cash_recevd','$payment_Id','$paymnt_meth','$current_due','$note','$today','$goods_name','$delvry_ctn','$total_g_w','$shipping_mark','$remaks','By Air')";
           $run = mysqli_query($con,$insert);
...
<div class="card">
  ...
  <div class="card-body" style="padding: 0px;">
   <h4 style="color:white; text-align:center; background-color: #1abc9c; padding:2px; font-weight:400;">Trade from air</h4>
     ...
     <table class="table-responsive border ">
         ...
         <?php if($role_name=='2'){ ?>
          <td>
           ...
           <td>
             <input type="text" name="goods_name" class="form_size"   value="<?php echo $goods_name; ?>"id="exampleInputPassword1"  >
           </td>
           <td>
           ...
           <td>
             <input type="text" class="form_size"  name="goods_name"   value="<?php echo $goods_name; ?>"id="exampleInputPassword1"  >
           </td>
           <td>
            <input type="text" class="form_size" name="ctn_qty" value="<?php echo $ctn_qty; ?>" id="exampleInputEmail1"   >
           </td>
           ...
           <td>
             <input type="text" class="form_size" name="delvry_we" value="<?php echo $delvry_we; ?>" id="exampleInputPassword1"  >
           </td>
           <td>
              <input type="text" class="form_size" name="total_g_w" id="total_gro_w"  value="<?php echo $total_g_w; ?>" >
           </td>
         ...
         <?php
                ...
                WHERE shipment_type='By Air' ORDER BY `tbl_payment`.`id` DESC";
                $run = mysqli_query($con,$select);
                while($result= mysqli_fetch_array($run)){ ?>
                  <tr>
                  <?php if($role_name=='2'){ ?>
  ...
  <div class="d-flex justify-content-end pt-1">
          <button class="btn btn-outline-success btn-sm" name="save">Save</button>
         </form>
