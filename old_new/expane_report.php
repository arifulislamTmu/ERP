                             ...
                             .container_print9{
                                ...
                                <div class="col-lg-12 py-2">
                                    ...
                                    <table class="tble">
                                        <thead>
                                            ...
                                            <?php if($expnc_id =='1'){ ?>
                                               <th style="width:16%;text-align:center" >Employe Name</th>
                                           <?php }?>
                               ...
                               <?php
                                   ...
                                   $selct_amont = "SELECT * from tbl_manage_expance WHERE date  BETWEEN '$form_date' AND '$to_date' AND expance_head ='$expnc_id'";
                                        ...
                                        <tr>
                                          <!-- faka row -->
                                          <td></td> <?php if($expnc_id =='1'){ ?> <td></td> <?php } ?><td class="border-0"></td><td style="text-align:right"><b></b></td><td></td>
                                      </tr>
                                        <tr>
                                          <td class="border-0"></td>     <?php if($expnc_id =='1'){ ?> <td></td> <?php } ?>  <td class="border-0"></td> <td class="border-0"></td><td style="text-align:right; border:0px solid skyblue"><b>Total  &nbsp;</b></td><td style="text-align:right; border:1px solid skyblue; "> 
                                          <b> <?php 
