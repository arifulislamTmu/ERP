            ...
            <div class="row">
               <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" required name="cmr_name" id="exampleInputEmail1" placeholder=" Name"> 
                    </div>
               </div>
               <div class="col-lg-4">
                <div class="form-group">
               ...
               <div class="col-lg-4">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" required name="cmr_mobile" id="exampleInputEmail1" placeholder="Phone" >
                </div>
           </div>
           <div class="col-lg-4">
                <div class="form-group">
