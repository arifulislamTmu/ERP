   ...
   <section class="content">
      <div class="row d-flex justify-content-center mt-4">
       <div class="col-lg-10 ">
        ...
        if(isset($_GET['inco_delt_id'])){
                 $del_id = $_GET['inco_delt_id'];
           
                 $delete = "DELETE FROM tbl_manage_income WHERE income_id ='$del_id'";
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td> <?php if($role_name=='0'){ ?><a style="font-size:20px; padding:10px;"href="manage_income_edit.php?income_id=<?php echo $result['income_id'];?>"><i class="fas fa-edit"></i></a> <a  style="font-size:20px; padding:10px; color:red;" onclick="return confirm('You are Sure..?')" href="?inco_delt_id=<?php echo $result['income_id'];?>"><i class="far fa-trash-alt"></i></a>  <?php }?></td>
                    </tr>
                  <?php } ?>
                </table>
              </div>
