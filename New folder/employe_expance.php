                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a style="font-size:20px; padding:10px;"href="?income_id=<?php echo $result['income_id'];?>"><i class="fas fa-edit"></i></a> <a  style="font-size:20px; padding:10px;"href=""><i class="far fa-trash-alt"></i></a></td>
                    </tr>
                  <?php } ?>
                </table>
              </div>
