                    ...
                    $count = 1;
                      ...
                      while($result = mysqli_fetch_array($run)){ ?>
                        <tr>
                          ...
                          <td><a style="font-size:20px; padding:10px; " href="customer_edit.php?cmr_id=<?php echo $result['cmr_p_id'];?>"><i class="fas fa-edit"></i></a> <a  style="font-size:20px; padding:10px;"href=""><i class="far fa-trash-alt"></i></a></td>
                        </tr>
                    <?php  } ?>
                </table>
              </div>
