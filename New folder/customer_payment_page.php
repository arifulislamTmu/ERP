  ...
  <div class="content-wrapper mt-0">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><a href="transition_details.php?usr_id=<?php echo $user_id = $_SESSION['usr_id'];?>" class="btn btn-primary"> <i class="fas fa-chevron-left"></i> Go Back</a></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="row d-flex justify-content-center mt-4">
        ...
        <?php
         ...
         if(isset($_POST['paynow'])){
              ...
              $update = "UPDATE tbl_payment SET cash_recevd = cash_recevd + '$recve_cash', current_due='$new_current_due', note='$note'  WHERE cmr_p_id='$get_user_id' AND transtion_id='$get_tastion_id'";
              ...
              <?php
                    if(isset($_POST['Updaet_date'])){
                      ...
                      $update = "UPDATE tbl_pay_invoice SET old_current_due='$pay_now', cash_recevd = cash_recevd-'$pay_now', new_due= new_due+'$pay_now'
                      WHERE payment_id='$payment_id'";
                        $run = mysqli_query($con,$update);

                        $update = "UPDATE tbl_payment SET cash_recevd = cash_recevd-'$pay_now', current_due = current_due+'$pay_now'  WHERE transtion_id ='$transetion_id'";
                        $run = mysqli_query($con,$update);
                        if($run){
                          echo $msg3;
                      ...
                      <div class="card">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                              ...
                              <input type="number" class="form-control" id="pay_now" name="recve_cash" placeholder="0"  >
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="form-group">
