                        ...
                        $count = 1;
                            ...
                            while($result = mysqli_fetch_array($run)){ ?>
                                <tr>
                                    ...
                                    <td class="text-center"><a class="btn btn-outline-danger"  style="font-size:15px; padding:5px; text-align:center; "href="income_head_add.php?id=<?php echo $result['in_h_id']?>"><i class="far fa-trash-alt"></i> Delete</a></td>
                                </tr>
                           <?php  }  ?>
