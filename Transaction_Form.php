...
$msg ='<div class="alert bg-success">
      ...
      if(isset($_POST['save'])){
        ...
        echo  $msg2;
           ...
           VALUES('$cmr_p_id','$transiton_Id','$ctn_no','$total_taka','$taka_delivery','$ctn_qty','$delvry_we','$taka_par_kg','$cash_recevd','$payment_Id','$paymnt_meth','$current_due','$note','$today','$goods_name','$delvry_ctn','$total_g_w','$shipping_mark','$remaks','By Air','0','$by_china')";
           $run = mysqli_query($con,$insert);
    ...
    <form action="" method="POST">
     ...
     <table class="table-responsive border ">
         ...
         <tr>
          ...
          <input type="hidden" name="by_air" value="By air">
           <td>
         ...
         <?php
                ...
                WHERE shipment_type='By Air' AND importer='' ORDER BY `tbl_payment`.`id` DESC";
                $run = mysqli_query($con,$select);
                while($result= mysqli_fetch_array($run)){ ?>
                  <tr>
