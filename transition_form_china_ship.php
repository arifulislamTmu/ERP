...
$msg ='<div class="alert bg-success">
      ...
      if(isset($_POST['save'])){
        ...
        echo  $msg2;
           ...
           VALUES('$cmr_p_id','$transiton_Id','$ctn_no','$total_taka','$taka_delivery','$ctn_qty','$delvry_we','$taka_par_kg','$cash_recevd','$payment_Id','$paymnt_meth','$current_due','$note','$today','$goods_name','$delvry_ctn','$total_g_w','$shipping_mark','$remaks','By Ship','0','By china')";
           $run = mysqli_query($con,$insert);
        ...
        <tr>
         ...
         <tr>
          ...
          <td>
           ...
           <input type="hidden" name="by_china" value="By china">
         ...
         <?php
                ...
                INNER JOIN tbl_payment ON tbl_customer.cmr_p_id = tbl_payment.cmr_p_id
                 WHERE shipment_type='By Ship' AND importer='By china' ORDER BY `tbl_payment`.`id` DESC";
                $run = mysqli_query($con,$select);
                while($result= mysqli_fetch_array($run)){ ?>
