    ...
    <section class="content ">
      <div class="row d-flex justify-content-center mt-4">
        ...
        <?php
          ...
          $msg5 ='<div class="alert bg-danger">
          <span class="closebtn" onclick= this.parentElement.style.display="none";>&times;</span> 
          <strong>Warning! </strong>Please any title in "Note Fild"....!
          </div>';
         ...
         if(isset($_POST['paynow'])){
              ...
              $select ="SELECT * FROM tbl_pay_invoice WHERE total_taka ='$total_taka'  AND cash_recevd ='$recve_cash' AND note='$note' AND date='$today' ";
                  $run = mysqli_query($con,$select);
                  if(mysqli_num_rows($run)>0){
                   echo $msg5;   
                  }else{
                    if($curren_due < $recve_cash ){
                      echo $msg4;
                    }else{
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="row border container_print2 ">
                      <div class="main_div_recipt ">
                           <div class="div-col-12_ricipr " >
                            <div class="div-col-3ricipt col-lg-3">
                                <div class="image_div"> 
                            </div>
                            </div>
                            <div class="div-col-3ricipt col-lg-3">
                     ...
                     <?php     } } ?>
                      ...
                      <div class="card-body">
                         <table class="table table-striped table-responsive table-bordered">
                           ...
                           <?php 
                           $count = 1;
                            $select ="SELECT * FROM tbl_pay_invoice WHERE cmr_p_id='$get_user_id' AND transtion_id='$get_tastion_id'  ORDER BY `tbl_pay_invoice`.`id` DESC ";
                            $run = mysqli_query($con,$select);
                            while($result = mysqli_fetch_array($run)){ ?>
                             <tr>
